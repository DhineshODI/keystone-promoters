        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="FooterSplit">
            <div className="FooterInnerDiv">
              <h5 className="subHeadingText ">use full link</h5>
              ...
              <ul className="footerListsul">
                ...
                <div>
                  ...
                  <li className="subHeadingText text-hover-underline">Blogs</li>
                  <li className="subHeadingText text-hover-underline">News</li>
                  <li className="subHeadingText text-hover-underline">
                    Contact Us
                  </li>
                </div>
